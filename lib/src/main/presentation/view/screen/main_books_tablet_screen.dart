import 'package:elec_lib_app/src/main/presentation/view_model/cubit/main_books_cubit.dart';
...
class MainBooksTabletScreen extends StatelessWidget {
  const MainBooksTabletScreen({super.key, required this.mainBooksState});
